...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Contact_Book", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("Contact_Book.storedata")
            do {
    ...
    // MARK: - Menu Buttons Handlers

    @IBAction func MFSaveButton_onClick(_ sender: Any) {
        SyncContacts()
    }
    
    @IBAction func MFLoadButton_onClick(_ sender: Any) {
        ReadContacts()
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "refreshTable"), object: nil)
    }
    @IBAction func MEDeleteButton_onClick(_ sender: Any) {
    }
}
